...
ActiveRecord::Schema.define(version: 20210119100630) do
  ...
  create_table "turnover_summary", force: true do |t|
    ...
    t.decimal  "ac",         precision: 32, scale: 16
    t.decimal  "ep",         precision: 32, scale: 16
    t.decimal  "ad",         precision: 32, scale: 16
    t.decimal  "bd",         precision: 32, scale: 16
    t.decimal  "hb",         precision: 32, scale: 16
    t.decimal  "am",         precision: 32, scale: 16
    t.decimal  "at",         precision: 32, scale: 16
    t.decimal  "fz",         precision: 32, scale: 16
    t.decimal  "ew",         precision: 32, scale: 16
